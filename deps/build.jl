...
download_info = Dict(
    Linux(:aarch64, libc=:glibc, compiler_abi=CompilerABI(:gcc4)) => ("$bin_prefix/ClpBuilder.v1.16.11.aarch64-linux-gnu-gcc4.tar.gz", "a0ad2c0e6fe476579284777cc75f1fd39b7c6cf2879756ba296d55e307c684b6"),
    Linux(:aarch64, libc=:glibc, compiler_abi=CompilerABI(:gcc7)) => ("$bin_prefix/ClpBuilder.v1.16.11.aarch64-linux-gnu-gcc7.tar.gz", "77f63d590bb6dcc107b90a436d2b54cf9f05b490f2018e4d474bd97993e8a91a"),
    Linux(:aarch64, libc=:glibc, compiler_abi=CompilerABI(:gcc8)) => ("$bin_prefix/ClpBuilder.v1.16.11.aarch64-linux-gnu-gcc8.tar.gz", "014f7f88d79bf20a153aec702923f25eece43ac5e038c91303aa876d1a7cfdd8"),
    Linux(:armv7l, libc=:glibc, call_abi=:eabihf, compiler_abi=CompilerABI(:gcc4)) => ("$bin_prefix/ClpBuilder.v1.16.11.arm-linux-gnueabihf-gcc4.tar.gz", "89164de43d740eea8a55c7617e204400ef3b7c22211fea3a159da483c781afa0"),
    Linux(:armv7l, libc=:glibc, call_abi=:eabihf, compiler_abi=CompilerABI(:gcc7)) => ("$bin_prefix/ClpBuilder.v1.16.11.arm-linux-gnueabihf-gcc7.tar.gz", "3412c59c6a3697f8e91ca683d57b009dbdd227bdae85559ee2654d28f965ce60"),
    Linux(:armv7l, libc=:glibc, call_abi=:eabihf, compiler_abi=CompilerABI(:gcc8)) => ("$bin_prefix/ClpBuilder.v1.16.11.arm-linux-gnueabihf-gcc8.tar.gz", "81f836db88981a8f574a8ae9f2b32a2a778157d3f8e70dfc7463233b7ee7e700"),
    Linux(:i686, libc=:glibc, compiler_abi=CompilerABI(:gcc4)) => ("$bin_prefix/ClpBuilder.v1.16.11.i686-linux-gnu-gcc4.tar.gz", "70bcd84c1040e1c655a873b139180d5fb042f03fe12c4a4b0c612935798e5561"),
    Linux(:i686, libc=:glibc, compiler_abi=CompilerABI(:gcc7)) => ("$bin_prefix/ClpBuilder.v1.16.11.i686-linux-gnu-gcc7.tar.gz", "2c9ae978514906dd4e2eb5970e29c8f6bdea62717d795b1bad1449654b089939"),
    Linux(:i686, libc=:glibc, compiler_abi=CompilerABI(:gcc8)) => ("$bin_prefix/ClpBuilder.v1.16.11.i686-linux-gnu-gcc8.tar.gz", "62c58de73ea4421339b672b32d1f7a6944cde9b14dd4e5336cd5176549f642ea"),
    Windows(:i686, compiler_abi=CompilerABI(:gcc6)) => ("$bin_prefix/ClpBuilder.v1.16.11.i686-w64-mingw32-gcc6.tar.gz", "b51543d4c0a605ff5743ffdd3af8333f8e3308d33c360986781c861ed5eca0ec"),
    Windows(:i686, compiler_abi=CompilerABI(:gcc7)) => ("$bin_prefix/ClpBuilder.v1.16.11.i686-w64-mingw32-gcc7.tar.gz", "c4a270ca640f54dd1a8b1b552b833af44336cd8f8e613d4cd3b60e746369a312"),
    Windows(:i686, compiler_abi=CompilerABI(:gcc8)) => ("$bin_prefix/ClpBuilder.v1.16.11.i686-w64-mingw32-gcc8.tar.gz", "8540f2d0781afe29cb1dfc9c521aac4c301e99e2aa268dad02150c54ae945087"),
    MacOS(:x86_64, compiler_abi=CompilerABI(:gcc4)) => ("$bin_prefix/ClpBuilder.v1.16.11.x86_64-apple-darwin14-gcc4.tar.gz", "cc2361f3fa5d2a6846fb60e93ad6f1685f7587f02ed1fa5269441cfbe2b63ec1"),
    MacOS(:x86_64, compiler_abi=CompilerABI(:gcc7)) => ("$bin_prefix/ClpBuilder.v1.16.11.x86_64-apple-darwin14-gcc7.tar.gz", "cba30bdc8c34ba4f728f615c267bcf8e04691ee449500dfd30cd245f0f27c845"),
    MacOS(:x86_64, compiler_abi=CompilerABI(:gcc8)) => ("$bin_prefix/ClpBuilder.v1.16.11.x86_64-apple-darwin14-gcc8.tar.gz", "cef4b61d1b3fa237dbe122be528b8020945cb9c2e531e1b37997823773f9fe9f"),
    Linux(:x86_64, libc=:glibc, compiler_abi=CompilerABI(:gcc4)) => ("$bin_prefix/ClpBuilder.v1.16.11.x86_64-linux-gnu-gcc4.tar.gz", "43101ef19a1474112d89286bc004c2ae3b27a8f0f6a0efb0bbcba06dc35d1776"),
    Linux(:x86_64, libc=:glibc, compiler_abi=CompilerABI(:gcc7)) => ("$bin_prefix/ClpBuilder.v1.16.11.x86_64-linux-gnu-gcc7.tar.gz", "905dcd0d847a248181a56fd6becc1242017475540add6fe17e9126ed652d2cd1"),
    Linux(:x86_64, libc=:glibc, compiler_abi=CompilerABI(:gcc8)) => ("$bin_prefix/ClpBuilder.v1.16.11.x86_64-linux-gnu-gcc8.tar.gz", "9e1a9a144bfe8deb42d926fb20f3f2f74be51410fca72b40e304c0fd6a06b83c"),
    Windows(:x86_64, compiler_abi=CompilerABI(:gcc6)) => ("$bin_prefix/ClpBuilder.v1.16.11.x86_64-w64-mingw32-gcc6.tar.gz", "a1899e26f0efb02a2698de42d505968aaa71d37423f8117769b6838f434a98cf"),
    Windows(:x86_64, compiler_abi=CompilerABI(:gcc7)) => ("$bin_prefix/ClpBuilder.v1.16.11.x86_64-w64-mingw32-gcc7.tar.gz", "8cbb5b98e9e0d1393f3dced1b42d6ef53c5e8f7ed1ffff173cc091de08bd3688"),
    Windows(:x86_64, compiler_abi=CompilerABI(:gcc8)) => ("$bin_prefix/ClpBuilder.v1.16.11.x86_64-w64-mingw32-gcc8.tar.gz", "bc690ab206389a69535a7b887550ff3a5a32e9772e605e322606b6e9ea520021"),
)                  
