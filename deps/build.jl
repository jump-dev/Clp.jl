...
download_info = Dict(
    Linux(:aarch64, libc=:glibc, compiler_abi=CompilerABI(:gcc4)) => ("$bin_prefix/ClpBuilder.v1.16.11.aarch64-linux-gnu-gcc4.tar.gz", "993f12f45acb44daa09457a36fdfc1b5b21951f8b21039db90727031e16a0ffa"),
    Linux(:aarch64, libc=:glibc, compiler_abi=CompilerABI(:gcc7)) => ("$bin_prefix/ClpBuilder.v1.16.11.aarch64-linux-gnu-gcc7.tar.gz", "c99b2462aef23227522a53f444bb4b942010172ca4e45d3cd39038561fa9fca3"),
    Linux(:aarch64, libc=:glibc, compiler_abi=CompilerABI(:gcc8)) => ("$bin_prefix/ClpBuilder.v1.16.11.aarch64-linux-gnu-gcc8.tar.gz", "a8e571463c2b3a3f0dd59c2c797e93f362a21f4d8e58d04b6e95c71f502d04e5"),
    Linux(:armv7l, libc=:glibc, call_abi=:eabihf, compiler_abi=CompilerABI(:gcc4)) => ("$bin_prefix/ClpBuilder.v1.16.11.arm-linux-gnueabihf-gcc4.tar.gz", "b012ba3f5c82b9f58c33aa133f80a543d799bbcbe80c1e17a52ace4a86e8a675"),
    Linux(:armv7l, libc=:glibc, call_abi=:eabihf, compiler_abi=CompilerABI(:gcc7)) => ("$bin_prefix/ClpBuilder.v1.16.11.arm-linux-gnueabihf-gcc7.tar.gz", "00919734e2b12c55b4f2ef6ad4312a7fafae8b6183679b41912ee42aa3b9067c"),
    Linux(:armv7l, libc=:glibc, call_abi=:eabihf, compiler_abi=CompilerABI(:gcc8)) => ("$bin_prefix/ClpBuilder.v1.16.11.arm-linux-gnueabihf-gcc8.tar.gz", "6bf687adb7ca9ed2eb3ce7d0bc9effdc38980f1db37ebe6b43f57c27b4b302c8"),
    Linux(:i686, libc=:glibc, compiler_abi=CompilerABI(:gcc4)) => ("$bin_prefix/ClpBuilder.v1.16.11.i686-linux-gnu-gcc4.tar.gz", "9a8ce0a6ea369e6304ce250d7267f62b7b7e87948521aff186bdfc9162089a73"),
    Linux(:i686, libc=:glibc, compiler_abi=CompilerABI(:gcc7)) => ("$bin_prefix/ClpBuilder.v1.16.11.i686-linux-gnu-gcc7.tar.gz", "3a87a10579d9cbeccbdd75670e0139f6a8cf69cc9cdcc923b2063ed853b8210e"),
    Linux(:i686, libc=:glibc, compiler_abi=CompilerABI(:gcc8)) => ("$bin_prefix/ClpBuilder.v1.16.11.i686-linux-gnu-gcc8.tar.gz", "25aa1c289f36f225ccde0be657bcd650181eaaebe32472a0a33605037d1ea638"),
    Windows(:i686, compiler_abi=CompilerABI(:gcc6)) => ("$bin_prefix/ClpBuilder.v1.16.11.i686-w64-mingw32-gcc6.tar.gz", "096c7a860d26c93e441fa01c2e78e2c7eb12cbf1a6f7684f61b3a035ebb6c122"),
    Windows(:i686, compiler_abi=CompilerABI(:gcc7)) => ("$bin_prefix/ClpBuilder.v1.16.11.i686-w64-mingw32-gcc7.tar.gz", "f38b2d3c49caf5124170f0558323ed9d90e2c184b7b95fd61a87da32f1f7fc56"),
    Windows(:i686, compiler_abi=CompilerABI(:gcc8)) => ("$bin_prefix/ClpBuilder.v1.16.11.i686-w64-mingw32-gcc8.tar.gz", "e7f69d63a5b49b20ea32cb3a1632d455c894eea8e4007f856cdb591469f6ef4d"),
    MacOS(:x86_64, compiler_abi=CompilerABI(:gcc4)) => ("$bin_prefix/ClpBuilder.v1.16.11.x86_64-apple-darwin14-gcc4.tar.gz", "36d54621e1a3e2883871fabe61b8f562d772fa53ca99a05daac60fd5ea2b8a9c"),
    MacOS(:x86_64, compiler_abi=CompilerABI(:gcc7)) => ("$bin_prefix/ClpBuilder.v1.16.11.x86_64-apple-darwin14-gcc7.tar.gz", "e3fbf82cad539e32a93e606fd43a263ce4ada12450d4ec053ad5b7bd7f96c5b0"),
    MacOS(:x86_64, compiler_abi=CompilerABI(:gcc8)) => ("$bin_prefix/ClpBuilder.v1.16.11.x86_64-apple-darwin14-gcc8.tar.gz", "543875923adbb97cd2fc76b13d05c91533b0d7ba896b3ce91a3ad5017e868a48"),
    Linux(:x86_64, libc=:glibc, compiler_abi=CompilerABI(:gcc4)) => ("$bin_prefix/ClpBuilder.v1.16.11.x86_64-linux-gnu-gcc4.tar.gz", "e83ef5e439a0e4535e588096d83c2d9095806a719d7352729cc1ee634f60d6c6"),
    Linux(:x86_64, libc=:glibc, compiler_abi=CompilerABI(:gcc7)) => ("$bin_prefix/ClpBuilder.v1.16.11.x86_64-linux-gnu-gcc7.tar.gz", "defb3400e2e7234d81bb373d851738ba84ca69e9b424dbbc6afb1e2731f0365b"),
    Linux(:x86_64, libc=:glibc, compiler_abi=CompilerABI(:gcc8)) => ("$bin_prefix/ClpBuilder.v1.16.11.x86_64-linux-gnu-gcc8.tar.gz", "6700da12d209fd94d7db29b34350e4c14d54c1645ccd6a71fb05c7e3ecb9864f"),
    Windows(:x86_64, compiler_abi=CompilerABI(:gcc6)) => ("$bin_prefix/ClpBuilder.v1.16.11.x86_64-w64-mingw32-gcc6.tar.gz", "4cb2cf9dee7c448ffa22400e8af06c48a5aa5d604406474f42f42bde8db4f906"),
    Windows(:x86_64, compiler_abi=CompilerABI(:gcc7)) => ("$bin_prefix/ClpBuilder.v1.16.11.x86_64-w64-mingw32-gcc7.tar.gz", "279fed0d5638bcb3beb6f2d2f349419a9cba623fee7a1ecbe8f3b05a603c3db8"),
    Windows(:x86_64, compiler_abi=CompilerABI(:gcc8)) => ("$bin_prefix/ClpBuilder.v1.16.11.x86_64-w64-mingw32-gcc8.tar.gz", "fb9190583bff8b5784971903b4ad0833ae5347b5dfa7d73dcd0f70d8e23bb32a"),
)
