...
dependencies = [
     "https://github.com/JuliaOpt/OsiBuilder/releases/download/v0.107.9-gcc/build_OsiBuilder.v0.107.9.jl",
     "https://github.com/JuliaOpt/CoinUtilsBuilder/releases/download/v2.10.14-1/build_CoinUtilsBuilder.v2.10.14.jl",
...
# Download binaries from hosted location
bin_prefix = "https://github.com/JuliaOpt/ClpBuilder/releases/download/v1.16.11-gcc"

# Listing of files generated by BinaryBuilder:
download_info = Dict(
    Windows(:x86_64, compiler_abi=CompilerABI(:gcc4)) => ("$bin_prefix/ClpBuilder.v1.16.11.x86_64-w64-mingw32-gcc4.tar.gz", "dfd8294c5e3850a0d0a5257a3098b4eb1f2b7a9700fc976828ff00a443e49618"),
    Windows(:x86_64, compiler_abi=CompilerABI(:gcc7)) => ("$bin_prefix/ClpBuilder.v1.16.11.x86_64-w64-mingw32-gcc7.tar.gz", "044dfa95936e835846a66f50d4d75b57748faf36d9b63299d4822f7730aab91e"),
    Windows(:x86_64, compiler_abi=CompilerABI(:gcc8)) => ("$bin_prefix/ClpBuilder.v1.16.11.x86_64-w64-mingw32-gcc8.tar.gz", "dce2ad6b2a073653de040c079e30ed76e577586c9618d532167c4ecdd7b60829"),
)
